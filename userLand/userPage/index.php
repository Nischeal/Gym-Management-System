...
$stmt = $conn->prepare("SELECT m.m_type, m.amount, m.enrolled_at, m.duration, t.fullname as trainer_name
                        FROM members m
                        LEFT JOIN users u ON m.u_id = u.u_id
                        LEFT JOIN trainers t ON u.t_id = t.t_id
                        WHERE m.u_id = ?");
            ...
            <div class="pricing-section" class="content-section" style="display: block;">
                <?php if ($membershipInfo && $membershipInfo['remaining_days'] > 0): ?>
                    ...
                    <div class="membership-plan">
                        ...
                        <p><strong id="large"><?php echo htmlspecialchars($membershipInfo['m_type']); ?></strong></p>
                        ...
                        <p><strong>Trainer:</strong> <?php echo htmlspecialchars($membershipInfo['trainer_name']); ?></p>
                    </div>
                <?php else: ?>
